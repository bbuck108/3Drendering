...
public class Start {
	...
	public static void main(String[] args) {
		...
		addToRenderList(new PhysicalObject(Vector.createFromRectangular(0, 0, 0), 1, Color.RED, new RectangularPrism(Vector.createFromRectangular(0, 0, 1000), Vector.createFromRectangular(100, 100, 100), new Rotation(0, 0, 0))));
		//
