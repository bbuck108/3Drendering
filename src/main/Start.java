...
public class Start {
	...
	public static void main(String[] args) {
		...
		//new Sphere(Vector.createFromRectangular(0, 0, 500), 20, Vector.createFromRectangular(25, 25, 0), 1, Color.RED);
		//x = new RectangularPrism(Vector.createFromRectangular(0, 0, 1000), 100, Vector.createFromRectangular(0, 0, 0), 1, Color.RED);
